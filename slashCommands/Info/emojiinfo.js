...
module.exports = {
    ...
    options: [
        ...
        { String: { name: "emoji", description: "De qué emoji quieres obtener detalles?", required: true } }, //to use in the code: interacton.getString("ping_amount")
        ...
        try {
            ...
            if ((emoji1 = emoteRegex.exec(emojiStr))) {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields(
                        {
                            name: handlemsg(client.la[ls].cmds.info.emojiinfo.embed.field1.title),
                            value: [
                        ...
                        {
                            name: handlemsg(client.la[ls].cmds.info.emojiinfo.embed.field2.title),
                            value: [
