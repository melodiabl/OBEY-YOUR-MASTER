...
<:arrow:832598861813776394> github.com/melodiabl is sponsoring them with some free / cheaper Hosting Methods,
<:arrow:832598861813776394> Thanks to them, we are able to host our Website, Bots and GAME SERVERS
<:arrow:832598861813776394> Our suggestion is, if you want to host Bots / Games / Websites, then go to [github.com/melodiabl](https://github.com/melodiabl)
...
[**Website:**](https://github.com/melodiabl)
[**__SPONSOR LINK!__**](https://github.com/melodiabl)
`
                )
            ...
            let embed2 = new EmbedBuilder()
                .setColor(es.color)
                .setTimestamp()
                .setFooter({ text: "github.com/melodiabl | Code  'x10' == -5%", iconURL: "https://imgur.com/UZo3emk.png" })
