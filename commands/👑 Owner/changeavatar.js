...
module.exports = {
    ...
    description:
        "Changes the Avatar of the BOT: I SUGGEST YOU TO DO IT LIKE THAT: Type the command in the Chat, attach an Image to the Comando (not via link, just add it) press enter",
