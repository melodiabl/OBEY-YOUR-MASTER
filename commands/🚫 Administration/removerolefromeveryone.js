...
module.exports = {
    ...
    cooldown: 60,
    usage: `removerolefromeveryone @Rol`,
    description: `Removes a Rol from every Usuario in this Guild`,
    type: "memberrole",
                ...
                message.reply({
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `Successfully removed ${role} from \`${success} Members\` of \`${counter} Members\`${failed != 0 ? `\n${failed} Members, did not get the Removido, redo it with: \`${prefix}removerolefromeveryone ${role.id}\`` : ""}`
                            ),
                    ],
                });
            }
