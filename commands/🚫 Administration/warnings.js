...
module.exports = {
    ...
    description: `Shows the warnings of a Usuario`,
...
**Warned by:** \`${message.guild.members.cache.get(warnings[i].moderator) ? message.guild.members.cache.get(warnings[i].moderator).user.username : warnings[i].moderator}\`
