...
const map = new Map();
const { EmbedBuilder, PermissionFlagsBits, MessageMentions } = require(`discord.js`);
...
module.exports = {
    ...
    description: `Removes a Rol from every MEMBER in this Guild who has the ROle`,
    type: "memberrole",
                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(es.wrongcolor)
                            .setFooter(client.getFooter(es))
                            .setTitle(`There are 0 Members who have that Rol`)
                ...
                message.reply({
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `Successfully removed ${role} from \`${success} MEMBERS\` of \`${counter} Members\`${failed != 0 ? `\n${failed} Members, did not get the Removido, redo it with: \`${prefix}removerolefromrole ${role.id}\`` : ""}`
                            ),
                    ],
                });
            }
