                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(es.wrongcolor)
                            .setFooter(client.getFooter(es))
                            .setTitle(`${allEmojis.msg.ERROR} **This Canal is not a Thread**`),
                    ],
                });
            if (!args[0])
                return message.reply({
            ...
            message.reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setFooter(client.getFooter(es))
                        .setTitle(
                            `${allEmojis.msg.SUCCESS} **Successfully changed the autoarchive Duración to \`${duration}\` of ${channel.name}**`
                        ),
                ],
            });
