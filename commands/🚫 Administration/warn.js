...
module.exports = {
    ...
    cooldown: 0.5,
    description: `Warns a Miembro with a Reason`,
    usage: `warn @Usuario [Reason]`,
    type: "member",
                    ...
                    .send({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setAuthor({ name: `You've got warned by: ${message.author.username}`, iconURL: message.author.displayAvatarURL() })
