...
module.exports = {
    ...
    cooldown: 60,
    usage: `removerolefrombots @Rol`,
    description: `Removes a Rol from every BOT in this Guild`,
    type: "memberrole",
                ...
                message.reply({
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `Successfully removed ${role} from \`${success} BOTS\` of \`${counter} BOTS\`${failed != 0 ? `\n${failed} Members, did not get the Removido, redo it with: \`${prefix}removerolefrombots ${role.id}\`` : ""}`
                            ),
                    ],
                });
            }
