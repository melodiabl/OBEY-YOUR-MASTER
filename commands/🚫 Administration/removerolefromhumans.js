...
module.exports = {
    ...
    cooldown: 60,
    usage: `removerolefromhumans @Rol`,
    description: `Removes a Rol from every HUMAN in this Guild`,
    type: "memberrole",
                ...
                message.reply({
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `Successfully removed ${role} from \`${success} HUMANS\` of \`${counter} HUMANS\`${failed != 0 ? `\n${failed} Members, did not get the Removido, redo it with: \`${prefix}removerolefromhumans ${role.id}\`` : ""}`
                            ),
                    ],
                });
            }
