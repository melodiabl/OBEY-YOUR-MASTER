            ...
            .reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setAuthor({ name: `${message.author.username} stares${message.mentions.users.first() ? " at " + message.mentions.users.first().username : " at nothing.."}`, iconURL: message.author.displayAvatarURL() }),
                ],
            })
            .catch(() => {});
    },
