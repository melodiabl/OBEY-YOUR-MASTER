    ...
    try {
      ...
      if (res.isPlaylist) {
        const embed = new EmbedBuilder()
          .setTitle(Format.title('💿', 'Álbum agregado'))
          .setDescription(`Se han agregado ${Format.bold(res.trackCount)} canciones del álbum ${Format.inlineCode(res.playlistName || 'Desconocido')}`)
          .setColor('#5865F2')
          .setTimestamp()
